<div class="page-sidebar custom-scrollbar">
    <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo base_url('checklist'); ?>" class="sidebar-header <?php echo $page == 'checklist' ? "active" : ''; ?>"><i class="icofont icofont-industries"></i><span>Check List</span></a></li>
