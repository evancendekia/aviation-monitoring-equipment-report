<div class="page-sidebar custom-scrollbar">
    <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo base_url('checklist'); ?>" class="sidebar-header <?php echo $page == 'checklist' ? "active" : ($page == 'detail_checklist' ? "active" : ($page == 'add_checklist' ? "active" : "")) ; ?>"><i class="icofont icofont-checked"></i><span>Check List</span></a></li>
        ...
        <li><a href="<?php echo base_url('sarfas'); ?>" class="sidebar-header <?php echo $page == 'equipment' ? "active" : ''; ?>"><i class="icofont icofont-industries"></i><span>Data sarfas</span></a></li>
