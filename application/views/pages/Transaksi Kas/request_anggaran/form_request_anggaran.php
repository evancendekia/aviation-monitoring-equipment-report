        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <div class="float-right card-header-right">
                    <div class="btn-group">
                        <div>
                            <button type="button" class="btn btn-danger font-weight-bold" data-toggle="modal"  data-target="#ResetPermintaanAnggaranModal">Reset</button>
                        </div>
                        <div class="px-2">
                        ...
                        <div class="col-5 offset-4">
                            ...
                            <div class="form-group m-form__group" style="height: 32px !important;">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="induk_anggaran" value="<?php echo $pa[0]['kode_induk']?>" class="form-control f-12" onclick="ChooseIndukAnggaran()" <?php echo $list_request == null ?'':'disabled';?>>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-hover align-items-center mb-3 f-12">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary">Jumlah (Rp)</th>
                    ...
                    <table class="table align-items-center mb-0 f-12">
                        ...
                        <tbody class="bg-light">
                            <tr >
                                ...
                                <td>
                                    <label>Jumlah</label>
                                    <input type='text' id='jumlah'class='text-right form-control f-12 priceformat' required>
                                </td>
                                <td>
...
<?php $this->load->view('modals/request_anggaran/modal_reset_permintaan_anggaran');?>
<?php $this->load->view('modals/request_anggaran/modal_delete_list');?>
