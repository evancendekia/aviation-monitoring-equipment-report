<script>
        ...
        $.ajax({
            ...
            type: 'POST',
         	...
         	data: {data : data_send},
          	cache: false,
          	success: function(msg){
                document.getElementById("induk_anggaran").disabled = true; 
    ...
    function DeleteDetail(list_pa){
        // const list = JSON.parse(list_pa);
        console.log(list_pa);
        document.getElementById("id_pa_detil").value = list_pa.id_pa_detil;
        document.getElementById("kode_unit_detil").innerText = ": "+list_pa.no_unit;
        document.getElementById("kode_anggaran_detil").innerText = ": "+list_pa.kode_anggaran;
        document.getElementById("nama_akun_detil").innerText = ": "+list_pa.nama_akun;
        document.getElementById("unit_kerja_detil").innerText = ": "+list_pa.unit_kerja;
        document.getElementById("unit_bisnis_detil").innerText = ": "+list_pa.unit_bisnis;
        document.getElementById("jumlah_detil").innerText = ": "+list_pa.jumlah;
        document.getElementById("keterangan_detil").innerText = ": "+list_pa.keterangan;
    }
</script>